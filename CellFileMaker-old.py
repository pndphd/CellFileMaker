...
os.environ['TMP'] = "C:\Users\peter.dudley\Desktop\Temp"
...
class CellFileMaker:
	...
	def run(self):
		...
		if result:
			...
			output1 = processing.runalg('saga:gridstatisticsforpolygons', coverLayer.source(), gridLayer.source(), False, False, False, False, False, True, False, False, 0, None)
			
			#tempLayer2 = self.iface.addVectorLayer(output1['RESULT'], "tempLayer2", "ogr")
			
			
			#outputFinal = processing.runalg('saga:gridstatisticsforpolygons', gravelLayer.source(), output1['RESULT'], False, False, False, False, False, True, False, False, 0, None)
			
			
			# tempLayer = QgsVectorLayer(outputFinal['RESULT'], "tempLayer", "ogr")
